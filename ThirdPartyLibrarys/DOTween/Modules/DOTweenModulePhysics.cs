...
namespace DG.Tweening
{
	public static class DOTweenModulePhysics
    {
        ...
        /// Also stores the rigidbody as the tween's target so it can be used for filtered operations</summary>
        /// <par name="endValue">The end value to reach</par><par name="duration">The duration of the tween</par>
        /// <par name="mode">Rotation mode</par>
        ...
        /// Also stores the rigidbody as the tween's target so it can be used for filtered operations</summary>
        /// <par name="towards">The position to look at</par><par name="duration">The duration of the tween</par>
        /// <par name="axisConstraint">Eventual axis constraint for the rotation</par>
        /// <par name="up">The vector that defines in which direction up is (default: Vector3.up)</par>
        ...
        /// <par name="path">The waypoints to go through</par>
        /// <par name="duration">The duration of the tween</par>
        /// <par name="pathType">The type of path: Linear (straight path) or CatmullRom (curved CatmullRom path)</par>
        /// <par name="pathMode">The path mode: 3D, side-scroller 2D, top-down 2D</par>
        /// <par name="resolution">The resolution of the path (useless in case of Linear paths): higher resolutions make for more detailed curved paths but are more expensive.
        /// Defaults to 10, but a value of 5 is usually enough if you don't have dramatic long curves between waypoints</par>
        /// <par name="gizmoColor">The color of the path (shown when gizmos are active in the Play panel and the tween is running)</par>
        ...
        /// <par name="path">The waypoint to go through</par>
        /// <par name="duration">The duration of the tween</par>
        /// <par name="pathType">The type of path: Linear (straight path) or CatmullRom (curved CatmullRom path)</par>
        /// <par name="pathMode">The path mode: 3D, side-scroller 2D, top-down 2D</par>
        /// <par name="resolution">The resolution of the path: higher resolutions make for more detailed curved paths but are more expensive.
        /// Defaults to 10, but a value of 5 is usually enough if you don't have dramatic long curves between waypoints</par>
        /// <par name="gizmoColor">The color of the path (shown when gizmos are active in the Play panel and the tween is running)</par>
