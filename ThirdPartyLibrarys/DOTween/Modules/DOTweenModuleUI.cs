...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        /// Also stores the image as the tween's target so it can be used for filtered operations</summary>
        /// <par name="endValue">The end value to reach (0 to 1)</par><par name="duration">The duration of the tween</par>
        ...
        /// Also stores the RectTransform as the tween's target so it can be used for filtered operations</summary>
        /// <par name="punch">The direction and strength of the punch (added to the RectTransform's current position)</par>
        /// <par name="duration">The duration of the tween</par>
        /// <par name="vibrato">Indicates how much will the punch vibrate</par>
        /// <par name="elasticity">Represents how much (0 to 1) the vector will go beyond the starting position when bouncing backwards.
        /// 1 creates a full oscillation between the punch direction and the opposite direction,
        /// while 0 oscillates only between the punch and the start position</par>
        /// <par name="snapping">If TRUE the tween will smoothly snap all values to integers</par>
        ...
        /// Also stores the RectTransform as the tween's target so it can be used for filtered operations</summary>
        /// <par name="duration">The duration of the tween</par>
        /// <par name="strength">The shake strength</par>
        /// <par name="vibrato">Indicates how much will the shake vibrate</par>
        /// <par name="randomness">Indicates how much the shake will be random (0 to 180 - values higher than 90 kind of suck, so beware). 
        /// Setting it to 0 will shake along a single direction.</par>
        /// <par name="snapping">If TRUE the tween will smoothly snap all values to integers</par>
        /// <par name="fadeOut">If TRUE the shake will automatically fadeOut smoothly within the tween's duration, otherwise it will not</par>
        ...
        /// Also stores the RectTransform as the tween's target so it can be used for filtered operations</summary>
        /// <par name="duration">The duration of the tween</par>
        /// <par name="strength">The shake strength on each axis</par>
        /// <par name="vibrato">Indicates how much will the shake vibrate</par>
        /// <par name="randomness">Indicates how much the shake will be random (0 to 180 - values higher than 90 kind of suck, so beware). 
        /// Setting it to 0 will shake along a single direction.</par>
        /// <par name="snapping">If TRUE the tween will smoothly snap all values to integers</par>
        ...
        /// Also stores the RectTransform as the tween's target so it can be used for filtered operations</summary>
        /// <par name="endValue">The end value to reach</par>
        /// <par name="jumpPower">Power of the jump (the max height of the jump is represented by this plus the final Y offset)</par>
        /// <par name="numJumps">Total number of jumps</par>
        /// <par name="duration">The duration of the tween</par>
        /// <par name="snapping">If TRUE the tween will smoothly snap all values to integers</par>
        ...
        /// Also stores the Text as the tween's target so it can be used for filtered operations</summary>
        /// <par name="endValue">The end string to tween to</par><par name="duration">The duration of the tween</par>
        /// <par name="richTextEnabled">If TRUE (default), rich text will be interpreted correctly while animated,
        /// otherwise all tags will be considered as normal text</par>
        /// <par name="scrambleMode">The type of scramble mode to use, if any</par>
        /// <par name="scrambleChars">A string containing the characters to use for scrambling.
        /// Use as many characters as possible (minimum 10) because DOTween uses a fast scramble mode which gives better results with more characters.
        /// Leave it to NULL (default) to use default ones</par>
        ...
        /// <par name="endValue">The value to tween to</par><par name="duration">The duration of the tween</par>
