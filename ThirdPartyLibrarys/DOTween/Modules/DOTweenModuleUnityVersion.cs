...
namespace DG.Tweening
{
	...
	public static class DOTweenModuleUnityVersion
    {
        ...
        /// (NOTE 1: only uses the colors of the gradient, not the alphas - NOTE 2: creates a Sequence, not a Tweener).
        /// Also stores the image as the tween's target so it can be used for filtered operations</summary>
        /// <par name="gradient">The gradient to use</par>
        /// <par name="property">The name of the material property to tween (like _Tint or _SpecColor)</par>
        ...
        /// </summary>
        /// <par name="elapsedLoops">Elapsed loops to wait for</par>
        ...
        /// </summary>
        /// <par name="position">Position (loops included, delays excluded) to wait for</par>
